...
$selectedLnk= "edit_products"; $selected_name="Edit Products";
...
<form id="register" action="<?php echo "/edit_products?book_id=$book_id"?>" method="POST" enctype="multipart/form-data">
<div class="">
